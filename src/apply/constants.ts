...
`- ${M3} Create File: <path>       (Create a new file with '+' prefixed lines)`,
  ...
  "",
  "### Edit Hunks",
  "Each edit hunk MUST start with @@. The text after @@ is a positioning hint — the tool searches for this text in the file to locate the edit. If omitted or not found, the tool relies on LINE anchors instead. Hunk lines MUST start with one of the following prefixes:",
  "- Edit context (' ') and removal ('-') lines MUST use LINE|CONTENT anchors.",
  "- Edit addition ('+') lines MUST NOT include LINE| prefixes.",
  "- ' ' for context",
  "- '-' for removed line",
  "- '+' for added line",
  "",
  ...
  "",
  "Important:",
     "- apply_patch returns updated LINE anchors upon success. You MUST use these for subsequent edits to the same files — NEVER re-read a file you just edited.",
