...
`- ${M3} Create File: <path>       (Create a new file with '+' prefixed lines)`,
  ...
  "",
  "### Edit Hunks",
  "Each edit hunk MUST start with @@. The text after @@ is a positioning hint — the tool searches for this text in the file to locate the edit. If omitted or not found, the tool relies on content matching and relocation.",
  "- Preferred style: use ' ' (context), '-' (remove), '+' (add).",
  "- Lenient style: unprefixed lines are accepted as additions.",
  "- Insertion-only hunks MUST include @@ context for deterministic placement.",
  "- Context/removal lines SHOULD be plain CONTENT.",
  "- ' ' for context",
  "- '-' for removed line",
  "- '+' for added line",
  "",
