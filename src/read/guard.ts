...
const NUDGE = "Note: You SHOULD use read for file inspection because it provides multi-file reads, offset/limit, and in-file search with LINE| anchors REQUIRED by apply_patch. You SHOULD NOT use bash for file inspection when read can access the target files.";
